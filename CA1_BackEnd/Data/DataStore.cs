...
namespace CA1_BackEnd.Data
{
    public static class DataStore
    {
        public static List<Meal> Meals { get; } = new List<Meal>
        {
            ...
            new Meal { Id = 34, Name = "Shrimp Tacos", Picture = "shrimp-tacos.jpg", TotalFat = 14.0, Rating = 4.7, Difficulty = "Medium", PrepTime = 15, CookTime = 10, Servings = 3, Calories = 360, Protein = 25, Category = "Dinner" },
