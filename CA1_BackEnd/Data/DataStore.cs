...
namespace CA1_BackEnd.Data
{
    public static class DataStore
    {
        public static List<Meal> Meals { get; } = new List<Meal>
        {
            ...
            new Meal { Id = 10, Name = "Omelette", Picture = "omelette.jpg", TotalFat = 12.0, Rating = 4.2, Difficulty = "Easy", PrepTime = 10, CookTime = 8, Servings = 2, Calories = 180, Protein = 12, Category = "Breakfast" },
            ...
            new Meal { Id = 13, Name = "Smoothie Bowl", Picture = "smoothie-bowl.jpg", TotalFat = 5.0, Rating = 4.8, Difficulty = "Easy", PrepTime = 10, CookTime = 0, Servings = 1, Calories = 180, Protein = 5, Category = "Breakfast" },
            ...
            new Meal { Id = 15, Name = "Granola Yogurt", Picture = "granola-yogurt.jpg", TotalFat = 6.0, Rating = 4.7, Difficulty = "Easy", PrepTime = 5, CookTime = 0, Servings = 1, Calories = 160, Protein = 8, Category = "Breakfast" },
